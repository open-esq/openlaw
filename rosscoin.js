...
const PURCHASE_RIGHTS_OWNERSHIP_THRESHOLD = "Purchase Rights Ownership Threshold"
const INFORMATION_RIGHTS_OWNERSHIP_THRESHOLD = "Information Rights Ownership Threshold"
...
class App extends React.Component {
  ...
  setTemplatePreview = async () => {
    const { compName, compStatus, compType, compJuris, compSign, compSignT, compEmail, compVal, offAmnt, serCurr, numShares, prcShares, prcThres, infoThres, effDate, investName, investSign, investTitle, investEmail, compiledTemplate } = this.state
    try {
      const params = {
        [COMPANY]: compName,
